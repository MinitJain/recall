    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: "var(--lp-text-primary)", display: "block" }}>
              Save anything.
            </span>
            <span
              style={{
          ...
          >
            The internet moves fast. Your saves shouldn&apos;t disappear with
            it. Recall bookmarks anything, tags it automatically, and brings it
            back when you need it - even when you&apos;ve forgotten what you
            saved.
          </p>
      ...
      >
        ...
        >
          ...
          <div data-animate style={{ position: "relative" }}>
            ...
            >
              I save 50 links a week. I read maybe 3. The rest just sit there,
              forgotten, useless. I knew I saved that article about{" "}
              <em>[thing]</em> but I can never find it. So I save it again. And
              again.
            </blockquote>
            <p
              style={{
      ...
      {/* ── FEATURES ──────────────────────────────────────────────────── */}
      <section
        style={{ padding: "100px 24px", background: "var(--lp-bg-secondary)" }}
      >
      ...
      <section
        id="how"
        style={{ padding: "100px 24px", background: "var(--lp-bg-primary)" }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            {HOW_STEPS.map((s, i) => (
              ...
              >
                ...
                {/* Step content */}
                <div
                  style={{ position: "relative", zIndex: 1, paddingTop: 20 }}
                >
                  <div
                    style={{
                      width: 56,
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              >
                At your desk, on your phone, on someone else&apos;s laptop. Open
                Recall, drop the link. Done.
              </p>
              <span
                style={{
                  marginTop: "auto",
            ...
            >
              ...
              >
                Reading something good? Hit the button. Saved before you finish
                the thought. No tab switching, no copy-paste, no friction.
              </p>
              <span
                style={{
                  marginTop: "auto",
            ...
            >
              ...
              >
                Not a Chrome person? Drag this link to your bookmarks bar once.
                From that moment on, every browser saves to Recall in one click.
              </p>
      ...
      <section
        style={{
          padding: "100px 24px",
          background:
            "linear-gradient(135deg, var(--lp-bg-elevated) 0%, var(--lp-bg-card) 100%)",
          borderTop: "1px solid var(--lp-border)",
          borderBottom: "1px solid var(--lp-border)",
        }}
      >
        <div style={{ maxWidth: 960, margin: "0 auto", textAlign: "center" }}>
          <div data-animate style={{ marginBottom: 60 }}>
            ...
            >
              <span
                style={{ color: "var(--lp-text-primary)", display: "block" }}
              >
                The internet gave it to you once.
              </span>
              <span style={{ color: "var(--lp-accent)", display: "block" }}>
                Recall gives it back.
              </span>
            </h2>
          </div>
          <div
      ...
      >
        ...
        <div style={{ display: "flex", gap: 24 }}>
          {[
            ["Privacy", "#"],
            ["Terms", "#"],
            ["GitHub", "https://github.com/MinitJain/recall"],
          ].map(([label, href]) => (
            <a
              key={label}
              href={href}
...
const STATS = [
  {
    value: "Any URL",
    label:
      "Tweet, video, article, Reddit thread - if it has a link, Recall saves it",
  },
  {
    value: "< 3 sec",
    label: "Average time for AI to tag and preview a new bookmark",
  },
  {
    value: "0 manual tags",
    label: "Required - AI handles it automatically, you can always add more",
  },
];
...
const FEATURES = [
  {
    icon: "🔖",
    title: "Save anything",
    desc: "Tweet, blog, video, image, Reddit thread, product page. If it has a URL, Recall saves it.",
    tag: "Any URL",
  },
  {
    icon: "🤖",
    title: "AI auto-tagging",
    desc: "The moment you save, AI reads the content and adds relevant tags. No manual work.",
    tag: "Instant",
  },
  {
    icon: "🔍",
    title: "Fuzzy AI search",
    desc: "Can't remember the title? Search by feeling. 'that article about focus and music' actually works.",
    tag: "Natural language",
  },
  {
    icon: "📁",
    title: "Collections",
    desc: "Group bookmarks into collections manually or let AI suggest groupings based on your saves.",
    tag: "Organized",
  },
  {
    icon: "✨",
    title: "Resurfacing",
    desc: "Recall brings things back to you - daily digest, random rediscovery, 'you saved this a year ago'.",
    tag: "Never forget",
  },
  {
    icon: "🖼️",
    title: "Rich previews",
    desc: "Every bookmark shows title, description, and preview image - fetched automatically from OG tags.",
    tag: "Beautiful",
  },
];
...
const HOW_STEPS = [
  {
    ...
    icon: "🔗",
    title: "Paste any URL",
    desc: "Copy a link from anywhere on the internet. Paste it into Recall.",
  },
  {
    num: "02",
    icon: "🤖",
    title: "AI does the rest",
    desc: "Title, tags, preview image, smart categorization - all automatic.",
  },
  {
    num: "03",
    icon: "✨",
    title: "Find it when you need it",
    desc: "Search naturally, browse collections, or let Recall surface it back to you.",
  },
];
...
const RESURFACE_MODES = [
  {
    icon: "🌅",
    title: "Daily digest",
    desc: "Every morning, 5 things you saved that are worth revisiting.",
  },
  {
    icon: "🎲",
    title: "Random rediscovery",
    desc: "Hit a button. See something you forgot you saved. Always surprising.",
  },
  {
    icon: "⏰",
    title: "Time capsule",
    desc: "'You saved this exactly one year ago.' Recall remembers so you don't have to.",
  },
];
